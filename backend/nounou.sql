...
CREATE TABLE IF NOT EXISTS `mydb`.`event` (
  ...
  CONSTRAINT `id_event_type`
    ...
    REFERENCES `nounous`.`eventTypes` (`id_event_type`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`prices` (
  ...
  `hourly_rate` DECIMAL(2) NULL,
  `household_rate` DECIMAL(2) NULL,
  `meal_price` DECIMAL(2) NULL,
  `snack_price` DECIMAL(2) NULL,
...
-- -----------------------------------------------------
-- Table `nounous`.`eventTypes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `nounous`.`eventTypes` (
...
-- Table `nounous`.`child`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `nounous`.`child` (
  `id_kid` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `nounous`.`userContract`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `nounous`.`userContract` (
  ...
  CONSTRAINT `id_kid`
    FOREIGN KEY (`kid_id`)
    REFERENCES `nounous`.`child` (`id_kid`),
  CONSTRAINT `id_user`
    FOREIGN KEY (`user_id`)
    REFERENCES `nounous`.`user` (`id_user`))
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `nounous`.`vacation` (
  ...
  `quantity` DECIMAL(2,0) NULL DEFAULT NULL COMMENT '2,5 par mois',
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`prices` (`id_prices`, `hourly_rate`, `household_rate`, `meal_price`, `snack_price`) VALUES (1, 3.80, 2.65, 3.50, 1.50);
INSERT INTO `mydb`.`prices` (`id_prices`, `hourly_rate`, `household_rate`, `meal_price`, `snack_price`) VALUES (2, 3.80, 3.39, 3.50, 1.50);
INSERT INTO `mydb`.`prices` (`id_prices`, `hourly_rate`, `household_rate`, `meal_price`, `snack_price`) VALUES (3, 4, 3.39, 3.50, 1.50);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`cycle` (`id_cycle`, `week`, `monday_start`, `tuesday_start`, `wednesday_start`, `thursday_start`, `friday_start`, `monday_duration`, `tuesday_duration`, `wednesday_duration`, `thursday_duration`, `friday_duration`) VALUES (3, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Version` (`contract_id`, `id_Version`, `starting_date`, `durations_id`, `prices_id`, `regulation_at_end`) VALUES (1, 1, '01/05/2021', 1, 1, NULL);
INSERT INTO `mydb`.`Version` (`contract_id`, `id_Version`, `starting_date`, `durations_id`, `prices_id`, `regulation_at_end`) VALUES (1, 2, '01/03/2022', 2, 2, NULL);
INSERT INTO `mydb`.`Version` (`contract_id`, `id_Version`, `starting_date`, `durations_id`, `prices_id`, `regulation_at_end`) VALUES (1, 3, '01/09/2022', 3, 3, NULL);
...
START TRANSACTION;
USE `nounous`;
INSERT INTO `nounous`.`user` (`id_user`, `lastname`, `firstname`, `role_id`, `email`) VALUES (1, 'D', 'Damien', 1, NULL);
INSERT INTO `nounous`.`user` (`id_user`, `lastname`, `firstname`, `role_id`, `email`) VALUES (2, 'S', 'Isabelle', 2, NULL);
INSERT INTO `nounous`.`user` (`id_user`, `lastname`, `firstname`, `role_id`, `email`) VALUES (3, 'DD', DEFAULT, 3, NULL);
INSERT INTO `nounous`.`user` (`id_user`, `lastname`, `firstname`, `role_id`, `email`) VALUES (4, 'who', 'remplaçante', 2, NULL);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`login` (`user_id`, `hashed_password`) VALUES (1, NULL);
INSERT INTO `mydb`.`login` (`user_id`, `hashed_password`) VALUES (2, NULL);
INSERT INTO `mydb`.`login` (`user_id`, `hashed_password`) VALUES (3, NULL);
INSERT INTO `mydb`.`login` (`user_id`, `hashed_password`) VALUES (4, NULL);

COMMIT;


-- -----------------------------------------------------
-- Data for table `nounous`.`eventTypes`
-- -----------------------------------------------------
START TRANSACTION;
USE `nounous`;
INSERT INTO `nounous`.`eventTypes` (`id_event_type`, `type`, `unit`, `is_paid`) VALUES (1, 'garde imprévue', 'jour', 1);
INSERT INTO `nounous`.`eventTypes` (`id_event_type`, `type`, `unit`, `is_paid`) VALUES (2, 'heures sup', 'heure', 1);
INSERT INTO `nounous`.`eventTypes` (`id_event_type`, `type`, `unit`, `is_paid`) VALUES (3, 'absence nounou journée', 'jour', 0);
INSERT INTO `nounous`.`eventTypes` (`id_event_type`, `type`, `unit`, `is_paid`) VALUES (4, 'absence nounou heures', 'heure', 0);
INSERT INTO `nounous`.`eventTypes` (`id_event_type`, `type`, `unit`, `is_paid`) VALUES (5, 'absence enfant journée', 'jour', 1);
INSERT INTO `nounous`.`eventTypes` (`id_event_type`, `type`, `unit`, `is_paid`) VALUES (6, 'absence enfant heures', 'heure', 1);
INSERT INTO `nounous`.`eventTypes` (`id_event_type`, `type`, `unit`, `is_paid`) VALUES (7, 'enfant malade', 'jour', 0);
INSERT INTO `nounous`.`eventTypes` (`id_event_type`, `type`, `unit`, `is_paid`) VALUES (8, 'congé', 'jour', 0);
INSERT INTO `nounous`.`eventTypes` (`id_event_type`, `type`, `unit`, `is_paid`) VALUES (9, 'formation', 'jour', 1);
INSERT INTO `nounous`.`eventTypes` (`id_event_type`, `type`, `unit`, `is_paid`) VALUES (10, 'férié non payé', 'jour', 0);
INSERT INTO `nounous`.`eventTypes` (`id_event_type`, `type`, `unit`, `is_paid`) VALUES (11, 'férié payé', 'jour', 1);
INSERT INTO `nounous`.`eventTypes` (`id_event_type`, `type`, `unit`, `is_paid`) VALUES (12, 'garde prévue', 'jour', 1);

COMMIT;


-- -----------------------------------------------------
-- Data for table `nounous`.`child`
-- -----------------------------------------------------
START TRANSACTION;
USE `nounous`;
INSERT INTO `nounous`.`child` (`id_kid`, `lastname`, `firstname`, `birthdate`) VALUES (1, 'D', 'Margot', '18/10/2020');

COMMIT;


-- -----------------------------------------------------
-- Data for table `nounous`.`userContract`
-- -----------------------------------------------------
START TRANSACTION;
USE `nounous`;
INSERT INTO `nounous`.`userContract` (`contract_id`, `user_id`, `kid_id`, `is_main`) VALUES (1, 1, 1, 1);
INSERT INTO `nounous`.`userContract` (`contract_id`, `user_id`, `kid_id`, `is_main`) VALUES (1, 2, 1, 1);
INSERT INTO `nounous`.`userContract` (`contract_id`, `user_id`, `kid_id`, `is_main`) VALUES (2, 1, 1, 0);
INSERT INTO `nounous`.`userContract` (`contract_id`, `user_id`, `kid_id`, `is_main`) VALUES (2, 4, 1, 0);
